...
\begin{figure}[H]
	\subfloat[Índice denso]{
		\includegraphics[scale=0.4]{dense_index}
	}
	\subfloat[Índice esparcido]{
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{transaction_manager}
...
\begin{figure}[H]
	\begin{centering}
		\subfloat[Lost Update]{
			\includegraphics[scale=0.4]{problem_lost_update}
		}
	\end{centering}
	\begin{centering}
		\subfloat[Dirty Read]{
			\includegraphics[scale=0.4]{problem_dirty_read}
		}
	\end{centering}
	
	\begin{centering}
		\subfloat[Incorrect Summary]{
			\includegraphics[scale=0.4]{problem_incorrect_summary}
		}
	\end{centering}
