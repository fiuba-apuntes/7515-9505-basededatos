...
\includegraphics[scale=0.6]{esquema_bd}
\par\end{centering}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.6]{diseno_bd}\protect\caption{Metodología de diseño de una base de datos}
\end{figure}
...
Tipos de atributos:
\begin{enumerate}
\item \emph{Simple vs compuesto. Ejemplo: nombre puede descomponerse en
primer nombre, segundo nombre, y apellido.}
\item \emph{Un valor vs Multivaluado}: se repite varias veces en la entidad.
\emph{Ejemplo: número de teléfono.}
\item \emph{Derivable}: su valor puede calcularse a partir de otros atributos.
Debe evitarse. \emph{Ejemplo: si tengo el atributo ``fecha de nacimiento'',
``edad'' es un atributo derivable.}
\end{enumerate}
\item \textbf{Identificador}: atributo o conjunto de atributos que permiten
distinguir a cada entidad dentro del conjunto de entidades del mismo
tipo.
\end{enumerate}
\end{description}
...
\begin{figure}[H]
\noindent \begin{centering}
\includegraphics[scale=0.5]{er_model}\protect\caption{``Tenencia'' es una interrelación entre dos entidades}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.6]{grados_interrelacion}\protect\caption{Grado de una interrelación}
\end{figure}
...
\noindent \begin{center}
\includegraphics[scale=0.25]{interrelacion}
\par\end{center}
...
\begin{figure}[H]
\noindent \begin{centering}
\includegraphics[scale=0.7]{cardinalidad_11}
\par\end{centering}
...
\begin{figure}[H]
\noindent \begin{centering}
\includegraphics{cardinalidad_1M}
\par\end{centering}
...
\begin{figure}[H]
\includegraphics[scale=0.7]{cardinalidad_MM}
...
\begin{figure}[H]
\subfloat[Índice denso]{\includegraphics[scale=0.4]{dense_index}



}\subfloat[Índice esparcido]{\includegraphics[scale=0.4]{sparse_index}
...
\begin{figure}[H]
\noindent \begin{centering}
\includegraphics[scale=0.7]{transaction_manager}\includegraphics[scale=0.8]{scheduler}
\par\end{centering}
...
\begin{figure}[H]
\noindent \begin{centering}
\subfloat[Lost Update]{\includegraphics[scale=0.5]{problem_lost_update}
...
\noindent \begin{centering}
\subfloat[Dirty Read]{\includegraphics[scale=0.5]{problem_dirty_read}

}
\par\end{centering}

\noindent \begin{centering}
\subfloat[Incorrect Summary]{\includegraphics[scale=0.5]{problem_incorrect_summary}}
\par\end{centering}
...
\end{itemize}
\begin{figure}[H]
\subfloat[Log UNDO]{\includegraphics[scale=0.5]{undo_logging}



}\subfloat[Log REDO]{\includegraphics[scale=0.5]{redo_logging}

}

\subfloat[Log UNDO/REDO]{\includegraphics[scale=0.5]{undo_redo_logging}
